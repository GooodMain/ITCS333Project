...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateSql = "UPDATE user SET fullName = ?, phoneNum = ?";
    $params = [$fullName, $phoneNum];
        ...
        <div class="card">
            ...
            <form id="profile-form" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-3">
                    ...
                    pattern="^(00973|\+973)?\s?(([36]\d{7})|(17\d{6}))$" 
                    title="Phone number must be Bahraini format (e.g., +973 3XXXXXXX or 17XXXXXX)" 
                    required
                    >
    <div class="invalid-feedback">Please enter a valid Bahraini phone number.</div>
</div>
...
<div class="mb-3">
    ...
    <input 
        ...
        pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])[A-Za-z0-9_#@%*\-]{8,50}$" 
        title="Password must be 8-50 characters, include uppercase, lowercase, digit, and special character." >
